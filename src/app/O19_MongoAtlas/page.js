...
export default function MongoAtlas() {
    return(
        <div className="flex justify-center items-center">
            ...
            <Link href="/O19_MongoAtlas/updateProduct" className="text-white bg-amber-50 border-2 border-black p-2 m-2 rounded-2xl">Update Product</Link>
            <Link href="/O19_MongoAtlas/deleteProduct" className="text-white bg-amber-50 border-2 border-black p-2 m-2 rounded-2xl">Delete Product</Link>
        </div>
    )
}
